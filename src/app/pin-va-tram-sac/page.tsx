...
export default function BatteryAndChargingStations() {
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row items-start justify-between max-w-[1080px] mx-auto gap-[30px] px-4 pb-[60px]">
